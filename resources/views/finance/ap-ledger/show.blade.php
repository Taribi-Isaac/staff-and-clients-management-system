...
<div class="container mx-auto px-6 pb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">AP Ledger Entry Details</h2>
    ...
    <div class="flex gap-4">
        <a href="{{ route('ap-ledger.edit', $entry->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-yellow-600 transition">Edit Entry</a>
        <a href="{{ route('ap-ledger.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-gray-600 transition">Back to AP Ledger</a>
    </div>
</div>
@endsection
