...
<div class="container mx-auto px-6 pb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Edit AP Ledger Entry</h2>

    <form action="{{ route('ap-ledger.update', $entry->id) }}" method="POST" class="bg-white p-8 rounded-lg shadow-md">
        @csrf
        @method('PUT')
            ...
            <div>
                ...
                <select name="purchase_entry_id" id="purchase_entry_id" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    @foreach($purchases as $purchase)
                        <option value="{{ $purchase->id }}" {{ old('purchase_entry_id', $entry->purchase_entry_id) == $purchase->id ? 'selected' : '' }}>
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('ap-ledger.show', $entry->id) }}" class="bg-gray-500 text-white px-6 py-3 rounded-md shadow-md hover:bg-gray-600 transition">Cancel</a>
