...
<div class="container mx-auto px-6 pb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Add Purchases Book Entry</h2>

    <form action="{{ route('purchases-book.store') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md">
        @csrf
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('purchases-book.index') }}" class="bg-gray-500 text-white px-6 py-3 rounded-md shadow-md hover:bg-gray-600 transition">Cancel</a>
