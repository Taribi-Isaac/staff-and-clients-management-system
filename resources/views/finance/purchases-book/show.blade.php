...
<div class="container mx-auto px-6 pb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Purchases Book Entry Details</h2>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <p class="text-lg">{{ $entry->supplier_name }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg">₦{{ number_format($entry->tax_amount, 2) }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Discount</label>
                <p class="text-lg">₦{{ number_format($entry->discount, 2) }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Total</label>
                <p class="text-lg font-semibold text-red-600">₦{{ number_format($entry->total, 2) }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg">{{ $entry->payment_method ?? 'N/A' }}</p>
            </div>
            <div>
    ...
    <div class="flex gap-4">
        <a href="{{ route('purchases-book.edit', $entry->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-yellow-600 transition">Edit Entry</a>
        <a href="{{ route('purchases-book.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-gray-600 transition">Back to Purchases Book</a>
    </div>
</div>
@endsection
