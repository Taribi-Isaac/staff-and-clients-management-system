...
<div class="container mx-auto px-6 pb-4">
    ...
    <h2 class="text-2xl font-semibold mb-4">Sales Book Entry Details</h2>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-green-600">₦{{ number_format($entry->total, 2) }}</p>
            </div>
            <div>
    ...
    <div class="flex gap-4">
        <a href="{{ route('sales-book.edit', $entry->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-yellow-600 transition">Edit Entry</a>
        <a href="{{ route('sales-book.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-gray-600 transition">Back to Sales Book</a>
    </div>
</div>
@endsection
