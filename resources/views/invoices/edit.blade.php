...
<div class="container mx-auto px-6 pb-4">
    <h1 class="text-3xl font-bold mb-6 text-center">Edit Invoice/Receipt</h1>
        ...
        <div class="mb-6 border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="client_id" id="client_id" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        ...
                        @foreach($clients as $client)
                            <option value="{{ $client->id }}" data-name="{{ $client->client_name }}" data-email="{{ $client->email }}" data-address="{{ $client->service_address ?? '' }}" {{ old('client_id', $invoice->client_id) == $client->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="client_name" id="client_name" value="{{ old('client_name', $invoice->client_name) }}" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                    @error('client_name')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
